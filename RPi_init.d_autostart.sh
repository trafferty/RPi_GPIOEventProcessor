...
case "$1" in
  start)
    ...
    /usr/bin/python /home/pi/src/RPi_GPIOEventProcessor/RPi_GPIOEventProcessor.py -g /home/pi/src/RPi_GPIOEventProcessor/GPIO.json -e /home/pi/src/RPi_GPIOEventProcessor/EventTriggers.json
    ;;
  stop)
